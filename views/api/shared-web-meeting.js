  ...
  try {
             ...
             <div class="wrap-blog">
                 ...
                 <div class="article__grid-meta article__grid-meta--has-image" dir="rtl">
                     <div class="wrap-blog-inner" dir="rtl">
                         ...
                         <div class="wishlist-btn" data-article-id="${blog._id}" id="wishlist-btn">
    ...
    document
      ...
      .addEventListener("click", (event) => {
        if (event.target.matches("[data-article-id]")) {
          const id = event.target.getAttribute("data-article-id");
          axios.post(`http://localhost:3000/api/v1/wishlist/blogs/${id}`);
        }
      });
  } catch (error) {
